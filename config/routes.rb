...
Rails.application.routes.draw do
  ...
  resources :choices, except: %i[new create destroy]
  ...
  resources :assigns, except: %i[new create destroy show]
  ...
  resources :views, except: %i[create destroy]
  ...
  scope '(:locale)' do
    resources :homepages, except: %i[new create destroy]
